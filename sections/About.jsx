  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      <motion.img
        ...
        src="/arrow-down.svg"
        alt="arrow down"
        className="object-contain w-[18px] h-[28px] mt-[28px]"
      />
    </motion.div>
  </section>
);
